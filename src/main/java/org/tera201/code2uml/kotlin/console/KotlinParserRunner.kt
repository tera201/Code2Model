...
class KotlinParserRunner {

    private val log: Logger = LoggerFactory.getLogger(KotlinParserRunner::class.java)
...
//            lexer.addErrorListener(errorListener)
            ...
            val listener = KotlinTreeListener(parser, dbBuilder, filePath, checksum)
